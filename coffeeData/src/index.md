        ...
        (() => {
          ...
          const updateVisualization = () => {
            ...
            const plot = Plot.plot({
              ...
              x: {
                label: currentParams.otherFactor, // Now shows the 'other factor'
                grid: true,
                // Removed tickFormat: "d" as it might not apply to all factors
                labelOffset: 35, // Adjusted label offset if needed
                fontSize: 14,
                fontWeight: "bold"
              },
              y: {
                label: currentParams.qualityParam, // Now shows the 'quality parameter'
                grid: true,
                tickFormat: "d", // Keep tickFormat for quality points
                labelOffset: 45, // Adjusted label offset if needed
                fontSize: 14,
                fontWeight: "bold"
              },
              style: {
              ...
              marks: [
                Plot.dot(processedData, {
                  // Swapped x and y data accessors
                ...
                Plot.linearRegressionY(processedData, {
                  // Swapped x and y data accessors for regression
                  x: d => d[currentParams.otherFactor],
                  y: d => d[currentParams.qualityParam],
                  stroke: "#c19a6b",
                  strokeWidth: 2.5,
...
.coffee-dropdown:hover, .coffee-dropdown:focus {
  border-color: #aa6122;
