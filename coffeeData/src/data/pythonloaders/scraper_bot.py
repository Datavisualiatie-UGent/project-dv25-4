...
login_email = "ben.demeurichy@gmail.com"
login_password = "}2ND8}c__HaW-=>"

# open chromedriver
driver = webdriver.Chrome(
    service=Service(ChromeDriverManager("134.0.6998.165").install())
)
time.sleep(2)
...
form = driver.find_element(
    "xpath",
    '//html/body/content[@class="scrollable"]/div[@class="container page"]/div[@class="form short"]/div[@class="login panel"]/form',
...
coffees = driver.find_element(
    "xpath",
    '//html/body/header/nav[@id="main"]/div[@class="container"]/div[@class="in"]/a[@href="/coffees"]',
).click()
time.sleep(10)
